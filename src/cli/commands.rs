...
pub struct Cli {
    ...
    #[arg(short, long, help = "Path to configuration file (defaults to user config dir)")]
...
pub enum Commands {
    ...
    Init {
        #[arg(short, long, help = "Output path for config file (defaults to user config dir)")]
    ...
    Sync {
        ...
        #[arg(short, long, help = "Daemon PID file path", default_value = ".sync-tool.pid")]
        pid_file: String,
    },
